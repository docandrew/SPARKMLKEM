...
--  tainted, TAMPERED ciphertext (implicit rejection path).
--
...
begin
   ...
   C (17) := C (17) xor 16#80#;   --  one flipped bit: re-encryption will not match
   ...
   Put_Line ("ct_decaps_reject: MLKEM_Decaps completed");
   Ada.Command_Line.Set_Exit_Status (0);
end Ct_Decaps_Reject;
